...
const LINE_BASE = { r: 0, g: 0, b: 0, a: 0.06 };
...
export default function KineticGrid({
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      // Light theme colors — subtle blue/purple accent matching the project brand
      const theme = {
        lineActive: { r: 74, g: 100, b: 200, a: 0.45 },
        nodeActive: { r: 74, g: 100, b: 200, a: 0.6 },
        glow: "74,100,200",
        ripple: "74,100,200",
      };
      ...
      // No fillRect for background

      // Static background dot texture (very subtle on light)
